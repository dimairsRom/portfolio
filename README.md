...
*3️⃣ Дополнить отчет о тестировании*  
  ...
  **Выводы:**  
При работе над этим проектом приобретались навыки по тестированию через API,  
составлению запросов в Postman, созданию Postman-коллекций и их экспорта, импорта.   
Проведению тест-ранов коллекций.      
